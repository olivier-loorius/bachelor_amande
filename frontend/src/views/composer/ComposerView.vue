      ...
      <div class="composer-card card">
        <section v-if="currentStep === 1 || currentStep === 2">
          ...
          <div v-else class="fond-carousel-mobile">
            ...
            >
              <div
                class="fond-card fond-card-mobile"
          ...
          <div v-if="isMobile">
            ...
            <div class="garniture-img-mobile-wrapper">
              <img
                v-if="selectedFond"
                :src="getGarnitureImage(selectedFond, selectedGarniture1)"
                :alt="selectedGarniture1?.nom || selectedFond.nom"
        ...
        <section v-if="currentStep === 3">
          ...
          <div v-if="isMobile">
            ...
            <div class="garniture-img-mobile-wrapper">
              <img
                v-if="selectedFond"
                :src="getGarnitureImage(selectedFond, selectedGarniture2)"
                :alt="selectedGarniture2?.nom || selectedFond.nom"
                class="garniture-img-mobile"
                @error="handleImageError"
              />
              <div v-else class="garniture-img-placeholder garniture-img-mobile">
        ...
        <section v-if="currentStep === 4">
          ...
          <div v-if="isMobile">
            ...
            <div class="garniture-img-mobile-wrapper">
              <img
                v-if="selectedFond"
                :src="getGarnitureImage(selectedFond, selectedGarniture3)"
                :alt="selectedGarniture3?.nom || selectedFond.nom"
                class="garniture-img-mobile"
                @error="handleImageError"
              />
              <div v-else class="garniture-img-placeholder garniture-img-mobile">
