        ...
        <div class="composer-card card">
          ...
          <section v-if="currentStep === 4">
            ...
            <div class="composer-footer">
              ...
              <div class="composer-nav-btns">
                ...
                <button class="composer-btn" :disabled="!selectedGarniture3" @click="goToNextStep">
                  Suivant
                  <svg style="margin-left:8px;vertical-align:middle;" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7 5l4 4-4 4" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </button>
              </div>
          ...
          <section v-if="currentStep === 5">
            ...
            <div style="display: flex; gap: 2.5rem; align-items: flex-start;">
              <div style="height: 312px; width: 220px; display: flex; flex-direction: column; justify-content: flex-start; align-items: flex-start;">
            ...
            <div class="composer-footer">
              ...
              <div class="composer-nav-btns">
                ...
                <button class="composer-btn-secondary" @click="recommencer(); currentStep = 1" style="display: flex; align-items: center; gap: 0.5em;">
                  <i class="fas fa-undo" style="font-size: 1.1em;"></i>
                  Recommencer
                </button>
                <button class="composer-btn panier-cta" :disabled="!quantite" @click="ajouterAuPanier" aria-label="Ajouter au panier">
